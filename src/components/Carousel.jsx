...
const images = [
  'https://via.placeholder.com/1200x500/8C1F28/FFFFFF?text=Modernidad+en+tu+Sonrisa', // brand-red-dark
  'https://via.placeholder.com/1200x500/044040/FFFFFF?text=Cuidado+Dental+Integral', // brand-teal-dark
  'https://via.placeholder.com/1200x500/D92525/FFFFFF?text=Resultados+Visibles',     // brand-red-accent
  'https://via.placeholder.com/1200x500/591C21/FFFFFF?text=Expertos+en+Tu+Salud',    // brand-red-deep
];
        ...
        {images.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full ${
              index === currentIndex ? 'bg-white' : 'bg-gray-400 bg-opacity-75'
            } transition-colors`}
          ></button>
        ))}
      </div>
