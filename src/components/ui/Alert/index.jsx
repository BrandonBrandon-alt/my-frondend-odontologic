...
/**
 * Componente Alert reutilizable para mostrar mensajes de diferentes tipos
 ...
 * @param {boolean} props.dismissible - Si se puede cerrar la alerta
 * @param {Function} props.onDismiss - Función llamada al cerrar la alerta
